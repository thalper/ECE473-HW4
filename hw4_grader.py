...
def add_parts_1(grader, submission):
    ...
    if grader.selectedPartName in ['1-2-basic', '1-3-hidden', '1-4-hidden', None]:  # avoid timeouts
    ...
    grader.addBasicPart('1-1-basic', t_1b_1, maxPoints=1, maxSeconds=2, description='simple test case using hand-picked unigram costs')
    ...
    grader.addBasicPart('1-2-basic', t_1b_2, maxPoints=1, maxSeconds=2, description='simple test case using unigram cost from the corpus')
    ...
    grader.addHiddenPart('1-3-hidden', t_1b_3, maxPoints=3, maxSeconds=3, description='simple hidden test case')
    ...
    grader.addHiddenPart('1-4-hidden', t_1b_4, maxPoints=5, maxSeconds=3, description='hidden test case for all queries in QUERIES_SEG')
...
def add_parts_2(grader, submission):
    ...
    if grader.selectedPartName in ['2-2-hidden', '2-4-hidden', None]:  # avoid timeouts
    ...
    grader.addBasicPart('2-1-basic', t_2b_1, maxPoints=1, maxSeconds=2, description='simple test case')
    ...
    grader.addHiddenPart('2-2-hidden', t_2b_2, maxPoints=3, maxSeconds=2, description='simple hidden test case')
    ...
    grader.addHiddenPart('2-3-hidden', t_2b_3, maxPoints=3, maxSeconds=3, description='simple hidden test case')
    ...
    grader.addHiddenPart('2-4-hidden', t_2b_4, maxPoints=3, maxSeconds=3, description='hidden test case for all queries in QUERIES_INS')
